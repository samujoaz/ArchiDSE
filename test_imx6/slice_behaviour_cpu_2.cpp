...
slice_behaviour_cpu_2::slice_behaviour_cpu_2()
{
input_.this_ = this;
counter = 0;
current_state_ = SA;
}
Runnable* slice_behaviour_cpu_2::get_input()
{
   return &input_;
}
Memory* slice_behaviour_cpu_2::get_memory_input()
{
   return &input_;
}
void slice_behaviour_cpu_2_input::run()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   int car_counter = 0;
   ...
   this_->input_run_characs_1[ car_counter ]->apply();
this_->counter++;
   this_->current_state_ = slice_behaviour_cpu_2::SA;
   return;
}
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter == 3 )  ))
{
...
int slice_behaviour_cpu_2_input::get_instr()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 6774460;
...
int slice_behaviour_cpu_2_input::get_load()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 1461621;
...
int slice_behaviour_cpu_2_input::get_store()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 733589;
...
int slice_behaviour_cpu_2_input::get_iL1_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 2000;
...
int slice_behaviour_cpu_2_input::get_lL1_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 1461;
...
int slice_behaviour_cpu_2_input::get_sL1_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 733;
...
int slice_behaviour_cpu_2_input::get_iL2_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 50;
...
int slice_behaviour_cpu_2_input::get_lL2_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 800;
...
int slice_behaviour_cpu_2_input::get_sL2_miss()
{
if( ( this_->current_state_ == slice_behaviour_cpu_2::SA)&& ( ( this_->counter < 3 )  ))
{
   return 500;
...
{   slice_behaviour_cpu_2* to_return = new slice_behaviour_cpu_2;
