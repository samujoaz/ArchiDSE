...
Runnable* main_behaviour_cpu_0::get_input_slice3()
{
   return &input_slice3_;
}
Memory* main_behaviour_cpu_0::get_memory_input_slice3()
{
   return &input_slice3_;
}
Runnable* main_behaviour_cpu_0::get_input_slice4()
{
   return &input_slice4_;
}
Memory* main_behaviour_cpu_0::get_memory_input_slice4()
{
   return &input_slice4_;
}
...
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   int car_counter = 0;
...
void main_behaviour_cpu_0_input_slice3::run()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   int car_counter = 0;
...
int main_behaviour_cpu_0_input_slice3::get_instr()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 10000;
...
int main_behaviour_cpu_0_input_slice3::get_load()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 1200;
...
int main_behaviour_cpu_0_input_slice3::get_store()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 500;
...
int main_behaviour_cpu_0_input_slice3::get_iL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 100;
...
int main_behaviour_cpu_0_input_slice3::get_lL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 120;
...
int main_behaviour_cpu_0_input_slice3::get_sL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 50;
...
int main_behaviour_cpu_0_input_slice3::get_iL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 10;
...
int main_behaviour_cpu_0_input_slice3::get_lL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 12;
...
int main_behaviour_cpu_0_input_slice3::get_sL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 5;
...
void main_behaviour_cpu_0_input_slice4::run()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   int car_counter = 0;
...
int main_behaviour_cpu_0_input_slice4::get_instr()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 10000;
...
int main_behaviour_cpu_0_input_slice4::get_load()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 1200;
...
int main_behaviour_cpu_0_input_slice4::get_store()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 500;
...
int main_behaviour_cpu_0_input_slice4::get_iL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 100;
...
int main_behaviour_cpu_0_input_slice4::get_lL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 120;
...
int main_behaviour_cpu_0_input_slice4::get_sL1_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 50;
...
int main_behaviour_cpu_0_input_slice4::get_iL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 10;
...
int main_behaviour_cpu_0_input_slice4::get_lL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 12;
...
int main_behaviour_cpu_0_input_slice4::get_sL2_miss()
{
if( ( this_->current_state_ == main_behaviour_cpu_0::SA)&& ( ( this_->counter < 3 )  ))
{
   return 5;
...
Timing_characteristics::initialise();

  {
    ...
    t_car_0->duration.tv_usec = 6622.72;
...
}
  {
    ...
    Timing_characteristics* t_car_0 = new Timing_characteristics;
    t_car_0->duration.tv_usec = 266.585;
    t_car_0->duration.tv_sec  = 0;
