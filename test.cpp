...
t1->configure_timerspec_and_sched_fifo( 0, 100000, 0, 50000000, true, 10 );
...
cnx_filter3.configure_affinity( 5 );
cnx_filter4.configure_priority_and_sched_fifo( 8, true );
cnx_filter4.configure_affinity( 6 );
...
cnx_write_buffer.configure_affinity( 5 );
t1->get_start()->run();
sleep( 3 );
t1->get_stop()->run();
Trace::dump();
