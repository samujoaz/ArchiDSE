...
filter_behaviour_cpu_2* filter2 = create_filter_timing_characs_cpu_2();
filter_behaviour_cpu_0* filter3 = create_filter_timing_characs_cpu_0();
filter_behaviour_cpu_1* filter4 = create_filter_timing_characs_cpu_1();
filter_behaviour_cpu_2* filter5 = create_filter_timing_characs_cpu_2();
...
cnx_filter4.configure_affinity( 1 );
