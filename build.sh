...
${CROSS_PREFIX}g++ test.cpp $COMPILE_OPTS -I $BENCH_ROOT/runtime -I . filter_behaviour_cpu_0.o filter_behaviour_cpu_2.o filter_behaviour_cpu_3.o filter_behaviour_cpu_4.o main_behaviour_cpu_1.o slice_behaviour_cpu_1.o slice_behaviour_cpu_2.o slice_behaviour_cpu_3.o write_buffer_behaviour_cpu_0.o -L $BENCH_ROOT/runtime -lruntime $LIBLINK -o test.exe
