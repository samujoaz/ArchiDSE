...
${CROSS_PREFIX}g++ test.cpp $COMPILE_OPTS -I $BENCH_ROOT/runtime -I . main_behaviour_cpu_0.o slice_behaviour_cpu_0.o slice_behaviour_cpu_1.o write_buffer_behaviour.o -L $BENCH_ROOT/runtime -lruntime $LIBLINK -o test.exe
