...
/// FIN partie1 ajouter par:samuel
    ...
    for (list < string >::iterator iter = selected_connections.begin(); iter != selected_connections.end(); iter++) {
        ...
        gnu_file_signals << " " << "\"" << individual_file << "\" with lines title " << "\"" << *iter << "\"";
        gnu_file_all << " " << "\"" << individual_file << "\" with lines title " << "\"" << *iter << "\"";
...
/// FIN partie ajouter par:samuel  
	...
	outfile.close();
        ...
        gnu_file_cpu << " " << "\"" << individual_file << "\" with lines title " << "\"" << *iter << "\"";
        gnu_file_all << " " << "\"" << individual_file << "\" with lines title " << "\"" << *iter << "\"";
