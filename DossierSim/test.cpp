...
t1->configure_timerspec_and_sched_fifo( 0, 100000, 0, 40000000, true, 99 );
...
cnx_main2.configure_affinity( 2 );
...
cnx_snk10111132.configure_affinity( 2 );
...
cnx_snk1221118.configure_affinity( 2 );
...
cnx_end12111132.configure_affinity( 1 );
