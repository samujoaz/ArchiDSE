...
void_behaviour_4::void_behaviour_4()
{
input_.this_ = this;
}
Runnable* void_behaviour_4::get_input()
{
   return &input_;
}
Memory* void_behaviour_4::get_memory_input()
{
   return &input_;
}
void void_behaviour_4_input::run()
{
{
   int car_counter = 0;
...
int void_behaviour_4_input::get_instr()
{
  return 0;
}
int void_behaviour_4_input::get_load()
{
  return 0;
}
int void_behaviour_4_input::get_store()
{
  return 0;
}
int void_behaviour_4_input::get_iL1_miss()
{
  return 0;
}
int void_behaviour_4_input::get_lL1_miss()
{
  return 0;
}
int void_behaviour_4_input::get_sL1_miss()
{
  return 0;
}
int void_behaviour_4_input::get_iL2_miss()
{
  return 0;
}
int void_behaviour_4_input::get_lL2_miss()
{
  return 0;
}
int void_behaviour_4_input::get_sL2_miss()
{
  return 0;
}
...
{   void_behaviour_4* to_return = new void_behaviour_4;
